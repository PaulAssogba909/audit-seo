import { captureGscSitemaps } from './server/modules/google_search_console.js';
...
const gscCookies = [
    ...
    { "domain": ".google.com", "expirationDate": 1803716247.767009, "hostOnly": false, "httpOnly": false, "name": "SIDCC", "path": "/", "sameSite": null, "secure": false, "session": false, "storeId": null, "value": "AKEyXzVHJzB9Uk1YGo2UB5w67bxzOosEEI_2mvgBY55FFQuhksbl1yhA4-aCZ_CzfUkvxNHWjIY" },
...
const auditId = 'test-local-' + Date.now();
const siteUrl = 'https://www.openai.com';
...
async function runTests() {
    ...
    console.log("\n1. Test GSC Sitemaps (Devrait détecter 'No access' ou réussir)");
    const gscRes = await captureGscSitemaps(siteUrl, auditId, gscCookies);
    console.log("GSC Result:", JSON.stringify(gscRes, null, 2));

    console.log("\n2. Test MRM (Devrait scroller au titre 4)");
